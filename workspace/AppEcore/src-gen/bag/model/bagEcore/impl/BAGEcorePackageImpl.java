...
public class BAGEcorePackageImpl extends EPackageImpl implements BAGEcorePackage {
	...
	public static BAGEcorePackage init() {
		if (isInited)
			return (BAGEcorePackage) EPackage.Registry.INSTANCE.getEPackage(BAGEcorePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBAGEcorePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		BAGEcorePackageImpl theBAGEcorePackage = registeredBAGEcorePackage instanceof BAGEcorePackageImpl
				? (BAGEcorePackageImpl) registeredBAGEcorePackage
				: new BAGEcorePackageImpl();

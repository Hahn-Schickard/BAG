 ...
 * </p>
 * <ul>
 *   <li>{@link bag.bagEcore.Filter#getMacaddress <em>Macaddress</em>}</li>
 * </ul>
 *
 * @see bag.bagEcore.AppEcorePackage#getFilter()
 * @model
 * @generated
 */
public interface Filter extends EObject {
	 ...
	 * The list contents are of type {@link bag.bagEcore.MacAddress}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Macaddress</em>' reference list.
	 * @see bag.bagEcore.AppEcorePackage#getFilter_Macaddress()

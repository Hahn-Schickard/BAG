...
import bag.formatting2.DSLFormatter;
import bag.generator.DSLGenerator;
import bag.parser.antlr.DSLAntlrTokenFileProvider;
import bag.parser.antlr.DSLParser;
import bag.parser.antlr.internal.InternalDSLLexer;
import bag.scoping.DSLScopeProvider;
import bag.serializer.DSLSemanticSequencer;
import bag.serializer.DSLSyntacticSequencer;
import bag.services.DSLGrammarAccess;
import bag.validation.DSLConfigurableIssueCodesProvider;
import bag.validation.DSLValidator;
...
public abstract class AbstractDSLRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "bag/DSL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("bag.DSL");
	}

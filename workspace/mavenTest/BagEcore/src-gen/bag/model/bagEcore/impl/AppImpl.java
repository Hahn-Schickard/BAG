...
public class AppImpl extends MinimalEObjectImpl.Container implements App
{
	...
	public NotificationChain basicSetSensor(Sensor newSensor, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BagEcorePackage.APP__SENSOR, oldSensor, newSensor);
	...
	public void setSensor(Sensor newSensor)
	{
		if (newSensor != sensor)
		{
			...
			if (sensor != null)
				msgs = ((InternalEObject)sensor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BagEcorePackage.APP__SENSOR, null, msgs);
			if (newSensor != null)
				msgs = ((InternalEObject)newSensor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BagEcorePackage.APP__SENSOR, null, msgs);
	...
	public NotificationChain basicSetMacfilter(MacFilter newMacfilter, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BagEcorePackage.APP__MACFILTER, oldMacfilter, newMacfilter);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMacfilter(MacFilter newMacfilter)
	{
		if (newMacfilter != macfilter)
		{
			NotificationChain msgs = null;
			if (macfilter != null)
				msgs = ((InternalEObject)macfilter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BagEcorePackage.APP__MACFILTER, null, msgs);
			if (newMacfilter != null)
				msgs = ((InternalEObject)newMacfilter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BagEcorePackage.APP__MACFILTER, null, msgs);
			msgs = basicSetMacfilter(newMacfilter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BagEcorePackage.APP__MACFILTER, newMacfilter, newMacfilter));
	}
	...
	public NotificationChain basicSetNamefilter(NameFilter newNamefilter, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BagEcorePackage.APP__NAMEFILTER, oldNamefilter, newNamefilter);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNamefilter(NameFilter newNamefilter)
	{
		if (newNamefilter != namefilter)
		{
			NotificationChain msgs = null;
			if (namefilter != null)
				msgs = ((InternalEObject)namefilter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BagEcorePackage.APP__NAMEFILTER, null, msgs);
			if (newNamefilter != null)
				msgs = ((InternalEObject)newNamefilter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BagEcorePackage.APP__NAMEFILTER, null, msgs);
			msgs = basicSetNamefilter(newNamefilter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BagEcorePackage.APP__NAMEFILTER, newNamefilter, newNamefilter));
	}
	...
	public void setPackageName(String newPackageName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BagEcorePackage.APP__PACKAGE_NAME, oldPackageName, packageName));
	}

...
public class CharacteristicImpl extends MinimalEObjectImpl.Container implements Characteristic
{
	...
	public void setDataType(DataType newDataType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BagEcorePackage.CHARACTERISTIC__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setWrite(boolean newWrite)
	{
		...
		write = newWrite;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BagEcorePackage.CHARACTERISTIC__WRITE, oldWrite, write));
	}
	...
	public void setNotification(boolean newNotification)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BagEcorePackage.CHARACTERISTIC__NOTIFICATION, oldNotification, notification));
	}
	...
	public NotificationChain basicSetUielement(UiElement newUielement, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BagEcorePackage.CHARACTERISTIC__UIELEMENT, oldUielement, newUielement);
	...
	public void setUielement(UiElement newUielement)
	{
		if (newUielement != uielement)
		{
			...
			if (uielement != null)
				msgs = ((InternalEObject)uielement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BagEcorePackage.CHARACTERISTIC__UIELEMENT, null, msgs);
			if (newUielement != null)
				msgs = ((InternalEObject)newUielement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BagEcorePackage.CHARACTERISTIC__UIELEMENT, null, msgs);
			msgs = basicSetUielement(newUielement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BagEcorePackage.CHARACTERISTIC__UIELEMENT, newUielement, newUielement));
	}

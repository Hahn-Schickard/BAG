 ...
 * @generated
 */
public class BagEcorePackageImpl extends EPackageImpl implements BagEcorePackage
{
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see bag.model.bagEcore.BagEcorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BagEcorePackageImpl()
	{
		super(eNS_URI, BagEcoreFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link BagEcorePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BagEcorePackage init()
	{
		if (isInited) return (BagEcorePackage)EPackage.Registry.INSTANCE.getEPackage(BagEcorePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBagEcorePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		BagEcorePackageImpl theBagEcorePackage = registeredBagEcorePackage instanceof BagEcorePackageImpl ? (BagEcorePackageImpl)registeredBagEcorePackage : new BagEcorePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theBagEcorePackage.createPackageContents();

		// Initialize created meta-data
		theBagEcorePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theBagEcorePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BagEcorePackage.eNS_URI, theBagEcorePackage);
		return theBagEcorePackage;
	}
	 ...
	 */
	@Override
	public BagEcoreFactory getBagEcoreFactory()
	{
		return (BagEcoreFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents()
	{
		...
		initEReference(getApp_Sensor(), this.getSensor(), null, "sensor", null, 1, 1, App.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getApp_Macfilter(), this.getMacFilter(), null, "macfilter", null, 0, 1, App.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getApp_Namefilter(), this.getNameFilter(), null, "namefilter", null, 0, 1, App.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getApp_PackageName(), ecorePackage.getEString(), "packageName", null, 1, 1, App.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSensor_Service(), this.getService(), null, "service", null, 1, -1, Sensor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(macFilterEClass, MacFilter.class, "MacFilter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMacFilter_Macaddress(), this.getMacAddress(), null, "macaddress", null, 1, -1, MacFilter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(macAddressEClass, MacAddress.class, "MacAddress", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMacAddress_Address(), ecorePackage.getEString(), "address", null, 1, 1, MacAddress.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCharacteristic_DataType(), this.getDataType(), "dataType", "Float", 1, 1, Characteristic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCharacteristic_Unit(), ecorePackage.getEString(), "unit", null, 0, 1, Characteristic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCharacteristic_Read(), ecorePackage.getEBoolean(), "read", "false", 1, 1, Characteristic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCharacteristic_Write(), ecorePackage.getEBoolean(), "write", "false", 1, 1, Characteristic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCharacteristic_Notification(), ecorePackage.getEBoolean(), "notification", "false", 1, 1, Characteristic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCharacteristic_Uielement(), this.getUiElement(), null, "uielement", null, 0, 1, Characteristic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(nameFilterEClass, NameFilter.class, "NameFilter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNameFilter_Name(), this.getNameExpression(), null, "name", null, 1, 1, NameFilter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(nameExpressionEClass, NameExpression.class, "NameExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNameExpression_RegEx(), ecorePackage.getEString(), "regEx", null, 1, 1, NameExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getService_Characteristic(), this.getCharacteristic(), null, "characteristic", null, 1, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUiElement_Name(), ecorePackage.getEString(), "name", null, 1, 1, UiElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUiElement_Label(), ecorePackage.getEString(), "label", null, 1, 1, UiElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

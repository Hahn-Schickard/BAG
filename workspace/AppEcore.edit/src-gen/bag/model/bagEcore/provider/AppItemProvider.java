...
/**
 * This is the item provider adapter for a {@link bag.model.bagEcore.App} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AppItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BAGEcorePackage.Literals.APP__NAME, true, false, false,
	...
	protected void addPackageNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_App_packageName_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_App_packageName_feature", "_UI_App_type"),
						BAGEcorePackage.Literals.APP__PACKAGE_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BAGEcorePackage.Literals.APP__SENSOR);
			childrenFeatures.add(BAGEcorePackage.Literals.APP__MACFILTER);
			childrenFeatures.add(BAGEcorePackage.Literals.APP__NAMEFILTER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(BAGEcorePackage.Literals.APP__SENSOR, BAGEcoreFactory.eINSTANCE.createSensor()));

		newChildDescriptors.add(createChildParameter(BAGEcorePackage.Literals.APP__MACFILTER,
				BAGEcoreFactory.eINSTANCE.createMacFilter()));

		newChildDescriptors.add(createChildParameter(BAGEcorePackage.Literals.APP__NAMEFILTER,
				BAGEcoreFactory.eINSTANCE.createNameFilter()));
	}
